process vcf_to_DF {
    ...
    script:
        ...
        ${params.pyscripts}/vcf_merge.py -n ${sample_id}_samtools_vartype.vcf
        ${params.pyscripts}/vcf_merge.py -n ${sample_id}_freeBayes_vartype.vcf
        ${params.pyscripts}/vcf_merge.py -n ${sample_id}_HaplotypeCaller_vartype.vcf
        ${params.pyscripts}/vcf_merge.py -n ${sample_id}_vardict_vartype.vcf
        """
}
...
process csv_merge {
    ...
    script:
        ...
        ${params.pyscripts}/csv_merge.py -v1 "${sample_id}_samtools.csv" -v2  '${sample_id}_freeBayes.csv' -v3 '${sample_id}_HaplotypeCaller.csv' -v4 '${sample_id}_vardict.csv'
