...
process WT_cov {
    ...
    script:
        ...
        """
        ${params.pyscripts}/Wt_cov.py -R ${ref} -G ${gff} -N '${sample_id}_depth.txt' -V ${voi} > ${sample_id}_coverage.csv
...
process Trim_Stats {
      ...
      script:
      """
      ${params.pyscripts}/Reads_stats.py  -S "${sample_id}.stats.txt" -N "${sample_id}_coverage.txt" > "${sample_id}_readcoverage.csv"
